...
# TASK DESCRIPTION
# Prepare a function that will receive two lists, the result should be a new list,
# whose elements will be sums

# Import libraries

# Welcome message
print('\nWelcome in "Sum lists" app.')
...
# Call function
ans = sum_lists(list1=given_list1, list2=given_list2)
